          ...
          <div className="flip-card-back">
            ...
            <div className="quote">
              <span className="text-align">
                <p>
                  State of having no fixed, regular and adequate nighttime
                  residence.
                </p>
              </span>
            ...
            <div className="quote">
              <span className="text-align">
                <p>
                  Homelessness is defined as living in a house that is below the
    ...
    return (
      <Card style={{ width: '18rem' }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            More tahn 100 people were trained in the stiching craft by
            4-Walls-For-All.
          </Card.Text>
    ...
    return (
      <Card style={{ width: '18rem' }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            TechCrunch organised an event to spread awareness of proper speaking
            and manners.
          </Card.Text>
          <Button variant="primary">Read More</Button>
        </Card.Body>
    ...
    return (
      <Card style={{ width: '18rem' }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            4-Walls-For-All in association with Google organised an event to
            team and ...
      ...
      <div className="homepage">
        ...
        <div className="quote">
          <Carousel controls="true" fade="true" indicators="false">
            <Carousel.Item>
              <img className="d-block" src={Background} alt="Third slide" />
              <Carousel.Caption>
                <p className="quote-text">
                  Homelessness is a mark of failure for communities in providing
                  basic security.{' '}
                </p>
            ...
            <Carousel.Item>
              ...
              <Carousel.Caption>
                <p className="quote-text">
                  The issue of modern homelessness is broad and complex,
                  affecting too many of our neighbors and communities.
                </p>
            ...
            <Carousel.Item>
              ...
              <Carousel.Caption>
                <p className="quote-text">
                  Homelessness can happen to anyone. Homelessness does not
                  define a person but is instead a temporary situation.{' '}
                </p>
                {/* <p className="quote-author"> Charlotte Bronte, Jane Eyre</p> */}
              </Carousel.Caption>
            </Carousel.Item>
            ...
            <Table striped bordered hover>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div className="eventDate">16 Feb,2020</div>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div className="eventTitle">
                      <h4>Nukkad Natal</h4>
                      At Orion Mall, Bangalore
                    </div>
                  </td>
                  <td>
                    <div className="eventDate">20 Feb,2020</div>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div className="eventTitle">
                      <h4>Plowing Session</h4>
                      At MG Road, Bangalore
                    </div>
                  </td>
                  <td>
                    <div className="eventDate">22 Feb,2020</div>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div className="eventTitle">
                      <h4>Female Hygine Awarness Session</h4>
                      At KVM School, Bangalore
                    </div>
                  </td>
                  <td>
                    <div className="eventDate">1 March,2020</div>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div className="eventTitle">
                      <h4>Flash Mob for Women Rights</h4>
                      At Meenakshi Mall, Bangalore
                    </div>
                  </td>
                  <td>
                    <div className="eventDate">10 March,2020</div>
                  </td>
                </tr>
              </tbody>
            </Table>
        ...
        <div className="joinUs">
          <div className="text">
            ...
            <br></br>
            <h3>
              Let's Create<br></br>A better and Happy World <br></br> Together
            </h3>
            <br></br>
